...
class RoofSolarPanel:
    ...
    Attributes:
        ...
        origin_lat (float): Latitude of model origin (degrees)
        origin_lon (float): Longitude of model origin (degrees)
    ...
    def __init__(self,
        ...
        Args:
            ...
            origin_lat: Geographic latitude of model origin
            origin_lon: Geographic longitude of model origin
...
if __name__ == "__main__":
    ...
    verts, faces = read_polyshape_3d.read_polyshape(
        "C:/Users/Sharon/Desktop/SGA21_roofOptimization-main/SGA21_roofOptimization-main/RoofGraphDataset/res_building/BJ39_500_099048_0008.polyshape"
    )
